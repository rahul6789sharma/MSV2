...
@JsonPropertyOrder({ "strikePrice", "expiryDate", "PE", "CE" })
public class Datum {
	...
	public Datum withStrikePrice(Integer strikePrice) {
		this.strikePrice = strikePrice;
		return this;
	}
	...
	public boolean equals(Object other) {
		...
		return new EqualsBuilder().append(strikePrice, rhs.strikePrice).append(expiryDate, rhs.expiryDate).append(pE, rhs.pE).append(cE, rhs.cE).append(additionalProperties, rhs.additionalProperties)
				.isEquals();
	}
