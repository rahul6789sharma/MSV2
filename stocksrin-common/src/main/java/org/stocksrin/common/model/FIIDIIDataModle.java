...
public class FIIDIIDataModle {
	...
	public String toCsv() {
		return this.date + "," + this.fii_BuyValue + "," + this.fii_SellValue + "," + this.fii_net + ","
				+ this.dii_BuyValue + "," + this.dii_SellValue + "," + this.dii_net + "," + this.niftyprice + ","
				+ this.niftyChange + "," + this.stocks_Advance + "," + this.stocks_Decline;
	}
	...
	public String toString() {
		return "FIIDIIDataModle [date=" + this.date + " fii_BuyValue=" + this.fii_BuyValue + " fii_SellValue="
				+ this.fii_SellValue + " fii_net=" + this.fii_net + " dii_BuyValue=" + this.dii_BuyValue
				+ " dii_SellValue=" + this.dii_SellValue + " dii_net=" + this.dii_net + " niftyprice=" + this.niftyprice
				+ " niftyChange=" + this.niftyChange + " stocks_Advance=" + this.stocks_Advance + " stocks_Decline="
				+ this.stocks_Decline + "]";
	}
}
