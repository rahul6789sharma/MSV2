...
public class AppConstant {
	...
	public static final String BNFNIFTY = "NIFTY_BNF";
	public static final String NIFTY = "NIFTY";

	public static final String EXPIRY = "Expiry";
	public static final String SECONDSESSIOON = "Eve";
	
	public static final String NSE_FO_OI_ALLPARTICAPENT = "https://www1.nseindia.com/content/nsccl/";
	...
	public static final String STOCKSRIN_OPTION_CHAIN_NIFTY_EOD = STOCKSRIN_NSE_CONF_DIR + "OptionChain" + File.separator + "Nifty" + File.separator;
	public static final String STOCKSRIN_OPTION_CHAIN_BNF_EOD = STOCKSRIN_NSE_CONF_DIR + "OptionChain" + File.separator + "BNF" + File.separator;
	...
	public static final String STOCKSRIN_OPTION_DATA_DIR_STOCKS_LIST = STOCKSRIN_NSE_CONF_DIR + "OptionData" + File.separator + "Stocks" + File.separator + "FNO.txt";
	public static final String STOCKSRIN_OPTION_DATA_DIR_STOCKS_LIST_2 = STOCKSRIN_NSE_CONF_DIR + "OptionData" + File.separator + "Stocks" + File.separator + "fo_mktlots.csv";
	...
	public static final String STOCKSRIN_OPTION_DATA_DIR_NIFTY_INTRDAY2_10MIN = STOCKSRIN_NSE_CONF_DIR + "OptionChainIntraDay2" + File.separator + "Nifty" + File.separator + "10MIN" + File.separator;
	public static final String STOCKSRIN_OPTION_DATA_DIR_NIFTY_INTRDAY2_5MIN = STOCKSRIN_NSE_CONF_DIR + "OptionChainIntraDay2" + File.separator + "Nifty" + File.separator + "5MIN" + File.separator;
	public static final String STOCKSRIN_OPTION_DATA_DIR_BANKNIFTY_INTRDAY2_10MIN = STOCKSRIN_NSE_CONF_DIR + "OptionChainIntraDay2" + File.separator + "BANKNIFTY" + File.separator+ "10MIN" + File.separator;
	public static final String STOCKSRIN_OPTION_DATA_DIR_BANKNIFTY_INTRDAY2_5MIN = STOCKSRIN_NSE_CONF_DIR + "OptionChainIntraDay2" + File.separator + "BANKNIFTY" + File.separator+ "5MIN" + File.separator;
	...
	public static final String STOCKSRIN_STRATEGY_DIR_BackTesting_NIFTY = STOCKSRIN_NSE_CONF_DIR + "Strategies" + File.separator + "BackTesting" + File.separator + "Nifty" + File.separator;
	...
	public static String getFutureURL(String symbole, String expiry, String insturmentType) {
		return FUTURE_URL + symbole + "&instrument=" + insturmentType + "&type=-&strike=-&expiry=" + expiry;
	}

	///////////////// v2 *****************

	public static final String OPTION_BASE_URL_V2 = "https://www.nseindia.com/api/option-chain-indices?symbol=";
