...
public class StrategyUtils2 {
	...
	public static Strategy buildStrategy(String name, List<OptionModle> optionModles, Integer strike, OptionType optionType, String expiry, double spotPrice, int qnt) throws Exception {
	...
	private static StrategyModel StrategyModelBuilderPUT(OptionModle optionModle, String expiry, Integer strike, double spotPrice, int qnt) throws Exception {
	...
	private static StrategyModel StrategyModelBuilderCALL(OptionModle optionModle, String expiry, Integer strike, double spotPrice, int qnt) throws Exception {
		StrategyModel strategyModel = new StrategyModel();
	...
	public static Strategy buildStrategy2(String name, List<OptionModle> optionModles, Integer strike, OptionType optionType, String expiry, double spotPrice, int qnt) throws Exception {
		Strategy strategy = new Strategy(UnderLyingInstrument.NIFTY);
		strategy.setStrategyName(name);
