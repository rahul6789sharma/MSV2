...
public class StrategyPrinterConsole {
	...
	public static StringBuilder print(Strategy strategy) throws Exception {
		...
		/*
		 * result.append("BreakEven : " + "[" + strategy.getLowerBreakEven() + " : " +
		 * strategy.getUpperBreakEven() + "], Range : " + "[" +
		 * (strategy.getUpperBreakEven() - strategy.getLowerBreakEven()) + "], " +
		 * "BreakEvenRangeFromTrade [" + strategy.getTradeSpotPrice() + "] [" + (int)
		 * (strategy.getLowerBreakEven() - strategy.getTradeSpotPrice()) + " : " + (int)
		 * (strategy.getUpperBreakEven() - strategy.getTradeSpotPrice()) + "]");
		 * 
		 * result.append("\n"); result.append("MaxLosses : " + "[" +
		 * strategy.getMaxLossLowerSide() + " : " + strategy.getMaxLossUpperSide() +
		 * "]"); result.append("\n"); result.append("MaxProfit : " + "[" +
		 * strategy.getMaxProfit() + "]"); result.append("\n");
		 */
		// result.append(line + "\n");
