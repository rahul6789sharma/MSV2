...
public class PriceUtils {
	...
	private static void loadBNLiveData() throws Exception {
		...
		Future future = FutureDataCollector.getFutureData("BANKNIFTY", monthlyExpiry, AppConstant.FUTIDX);
	...
	private static void loadNiftyData() throws Exception {
		...
		Future future = FutureDataCollector.getFutureData("NIFTY", monthlyExpiry, AppConstant.FUTIDX);
