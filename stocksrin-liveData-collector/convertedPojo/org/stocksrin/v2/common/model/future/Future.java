...
public class Future {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(info).append(underlyingValue).append(vfq).append(futTimestamp).append(optTimestamp).append(stocks).append(strikePrices).append(expiryDates).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(info, rhs.info).append(underlyingValue, rhs.underlyingValue).append(vfq, rhs.vfq).append(futTimestamp, rhs.futTimestamp).append(optTimestamp, rhs.optTimestamp).append(stocks, rhs.stocks).append(strikePrices, rhs.strikePrices).append(expiryDates, rhs.expiryDates).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
