...
public class Info {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(symbol).append(companyName).append(industry).append(activeSeries).append(debtSeries).append(tempSuspendedSeries).append(isFNOSec).append(isCASec).append(isSLBSec).append(isDebtSec).append(isSuspended).append(isETFSec).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        Info rhs = ((Info) other);
        return new EqualsBuilder().append(symbol, rhs.symbol).append(companyName, rhs.companyName).append(industry, rhs.industry).append(activeSeries, rhs.activeSeries).append(debtSeries, rhs.debtSeries).append(tempSuspendedSeries, rhs.tempSuspendedSeries).append(isFNOSec, rhs.isFNOSec).append(isCASec, rhs.isCASec).append(isSLBSec, rhs.isSLBSec).append(isDebtSec, rhs.isDebtSec).append(isSuspended, rhs.isSuspended).append(isETFSec, rhs.isETFSec).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
